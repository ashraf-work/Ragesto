...
const QuickActions = () => {
  ...
  return (
    <div className="premium-panel overflow-hidden">
      <div className="p-6 sm:p-8 border-b border-[var(--border)] bg-[rgba(239,246,255,0.46)]">
      ...
      <div className="p-6 sm:p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <button
            ...
            className="group premium-card flex items-center space-x-4 p-4 sm:p-6 text-left"
          >
